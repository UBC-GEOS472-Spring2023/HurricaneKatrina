...
<html>
  ...
  <body>
    ...
    <div class="legend">
      <h4>Louisiana: Income below poverty level (Total Population)</h4>
      <div class="legend-item"><span class="legend-color" style= 'background-color:#eff3ff;'></span><span class="legend-label">0-500 people</span></div>
      <div class="legend-item"><span class="legend-color" style= 'background-color:#bdd7e7;'></span><span class="legend-label">500+ people</span></div>
      <div class="legend-item"><span class="legend-color" style= 'background-color:#6baed6;'></span><span class="legend-label">2000+ people</span></div>
      <div class="legend-item"><span class="legend-color" style= 'background-color:#3182bd;'></span><span class="legend-label">2000+ people</span></div>
      <div class="legend-item"><span class="legend-color" style= 'background-color:#08519c;'></span><span class="legend-label">3000+ people</span></div>
    </div>
   ...
   <div id="button-container">
    ...
    <script>
      ...
      var map = new mapboxgl.Map({
        container: 'map',
        style: 'mapbox://styles/kdante/clguglyeb002701po34xb1ozf',
